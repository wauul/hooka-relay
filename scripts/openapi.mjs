...
const schemas = {
  EventInput: object({ customerId: { ...string, description: "Required for customer-isolated applications, including all new applications." }, type: { ...string, minLength: 1, maxLength: 120, pattern: "^[A-Za-z0-9_.:-]+$" }, payload: {}, idempotencyKey: { ...string, minLength: 1, maxLength: 200, pattern: "^[!-~]+$" } }, ["type", "payload"]),
