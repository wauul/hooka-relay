...
const schemas = {
  ...
  Endpoint: object({ id: string, url: string, eventTypes: array(string), circuitState: { enum: ["CLOSED", "OPEN", "HALF_OPEN"], type: "string" }, status: { enum: ["ACTIVE", "PAUSED", "DISABLED"], type: "string" }, userStatus: { enum: ["ACTIVE", "PAUSED"], type: "string" }, environment: string, kind: { enum: ["BUSINESS", "OPERATIONAL"], type: "string" }, deliveryRatePerMinute: nullable(integer), signatureFormat: { enum: ["STANDARD"], type: "string" }, createdAt: date, successRate: nullable(integer) }),
