...
import { Activity, Radio, List, KeyRound, Settings, Users, Mail, BookOpen, Code2, RefreshCw } from "lucide-react";
const icons = { overview: Activity, endpoints: Radio, events: List, security: KeyRound, settings: Settings, members: Users, invitations: Mail, send: BookOpen, signatures: KeyRound, retries: RefreshCw, "api-reference": Code2, faq: BookOpen };
